  ...
  return (
    <div className="py-12 sm:py-20 bg-[#FAF8F5] min-h-screen">
      <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6 pb-12 border-b border-[#E7E3DA]">
          ...
          <div>
            <a
              ...
              className="inline-flex items-center gap-2 min-h-[44px] px-6 py-3.5 rounded-full text-xs font-semibold uppercase tracking-wider bg-[#121316] text-white hover:bg-[#FF3E1D] transition-all duration-300 shadow-sm"
            >
          ...
          {experiences.map((exp, idx) => {
            ...
            return (
              <motion.article
                ...
                className="bg-white rounded-3xl border border-[#E7E3DA] p-6 sm:p-10 lg:p-14 shadow-sm hover:border-[#C4C0B6] transition-all"
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12">
                  {/* Left Role Header */}
                  <div className="lg:col-span-4 space-y-4 pb-6 lg:pb-0 border-b lg:border-b-0 lg:border-r border-[#F0ECE4] lg:pr-8">
                    ...
                    <h2 className="text-xl sm:text-2xl lg:text-3xl font-display font-normal text-[#121316] leading-tight break-words">
                      {exp.role}
                    </h2>
        ...
        <section className="space-y-6 mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {education.map((edu, idx) => (
              <div
                key={idx}
                className="p-6 sm:p-8 rounded-3xl bg-white border border-[#E7E3DA] space-y-3 shadow-sm flex flex-col justify-between"
              >
        ...
        {/* Bottom CTA */}
        <footer className="pt-10 sm:pt-12 border-t border-[#E7E3DA] flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 sm:gap-6">
          <Link
            href="/work"
            className="inline-flex items-center justify-center sm:justify-start gap-2 min-h-[44px] text-xs font-semibold uppercase tracking-wider text-[#121316] hover:text-[#FF3E1D] transition-colors"
          >
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center gap-2 min-h-[44px] px-6 py-3 rounded-full text-xs font-semibold uppercase tracking-wider bg-[#121316] text-white hover:bg-[#FF3E1D] transition-colors shadow-sm"
          >
