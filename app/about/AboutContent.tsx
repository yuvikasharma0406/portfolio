    ...
    <div className="py-12 sm:py-20 bg-[#FAF8F5] min-h-screen">
      <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <section className="space-y-8 mb-20">
          <div className="p-6 sm:p-12 rounded-3xl bg-white border border-[#E7E3DA] space-y-6 shadow-sm">
        ...
        <section className="space-y-6 mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {OBSERVATIONS.map((item, idx) => (
              <div
                key={idx}
                className="p-6 sm:p-8 rounded-3xl bg-white border border-[#E7E3DA] space-y-3 shadow-sm hover:border-[#121316] transition-colors"
              >
        ...
        <section className="space-y-6 mb-20">
          ...
          <div className="p-6 sm:p-10 rounded-3xl bg-white border border-[#E7E3DA] space-y-8 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          {/* Certifications */}
          <div className="p-6 sm:p-8 rounded-3xl bg-white border border-[#E7E3DA] space-y-5 shadow-sm">
            <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-[#FF3E1D]">
